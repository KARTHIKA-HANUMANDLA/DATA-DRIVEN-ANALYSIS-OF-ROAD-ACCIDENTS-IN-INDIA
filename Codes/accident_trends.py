...
sns.barplot(x=yearly_accident_counts.index, y=yearly_accident_counts.values, color='skyblue')
...
sns.barplot(x=monthly_accident_counts.index, y=monthly_accident_counts.values, color='lightcoral')
